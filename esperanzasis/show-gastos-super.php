    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container">
                    <div class="row">
                        <h2 class="d-flex justify-content-start mb-4">Lista de gastos súper</h2>
                                        ...
                                        <table class="table table-bordered" id="render-table" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    $showData = "SELECT * FROM cutbox_super ORDER BY opening_date ASC";
                                                    $result = mysqli_query($conexion, $showData);
