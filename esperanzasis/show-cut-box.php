                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo date('g:i a', strtotime($row['hour_opening'])); ?></td>
                                                    <td><?php echo date('g:i a', strtotime($row['hour_saved_cut'])); ?></td>
                                                    <!-- <td><?php echo number_format($row['opening_amount'], 2); ?></td> -->
