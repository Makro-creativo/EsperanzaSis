<?php
    ...
    if(isset($_POST['newOrder'])){
        ...
        //INSERTA ORDER
            $query_orders = "INSERT INTO orders_admin(id_user, name_order, address_send, date_send, hour_send, people_order, comments, name_delivery, date_purchase, status_payment, note_cobranza_credito) VALUES('$id_user', '$nameClient', '$addressSend', '$dateSend', '$hourSend', '$peopleOrder', '$comments', '$nameDelivery', NOW(), '$statusPayment', '$noteCredito')";
