...
if(isset($_POST['generate-report'])) {
	...
	header('Content-Disposition: attachment; filename="Reporte_de_pedidos_a_credito.csv"');
	...
	AND new_orders_admin.status_payment = 'credito' GROUP BY new_orders_admin.id ORDER BY new_orders_admin.date_send DESC");
