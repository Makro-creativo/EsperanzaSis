<?php 
    ...
    if(isset($_POST['save'])) {
        ...
        $query_products = "INSERT INTO products_admin(name_product, price, unidad) VALUES ('$name_product', '$price', '$unidad')";
        ...
        header("location: show-products-admin.php");
    }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-12 mx-auto">
                            <div class="card shadow-lg">
                                ...
                                <div class="card-body">
                                    <form action="new-product-admin.php" method="POST">
                                        <div class="row">
