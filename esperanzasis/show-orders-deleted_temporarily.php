    ...
    <div id="wrapper">
        ...
        ?>
            <script>
                Swal.fire({
                    title: 'Listo',
                    text: 'Se restauro correctamente!',
                    icon: 'success',
                        confirmButtonText: 'Ok'
                    })
                    .then(function() {
                        window.location = "show-orders-deleted_temporarily.php";
                });
            </script>
        <?php } ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container">
                    <div class="row">
                        <h2 class="d-flex justify-content-start mb-4">Lista de pedidos eliminados temporalmente</h2>
                                        ...
                                        <table class="table table-bordered" id="dataTable">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    $search_order_admin = "SELECT * FROM ordens_admin WHERE delete_tempory = 1 ORDER BY date DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if($typeUser === "SuperAdmin") {?>
                                                        <td class="text-center"> 
                                                            <a href="restore-orders-for-id.php?purchaseid=<?php echo $row['purchaseid']; ?>" class="btn btn-success btn-sm">
