...
if(isset($_POST['generate-report'])) {
	...
	header('Content-Disposition: attachment; filename="Reporte_de_cobranza_tortilleria.csv"');
	...
	$reporteCsv = $conexion->query("SELECT * FROM cutbox_ruta WHERE opening_date BETWEEN '$date1' AND '$date2' AND turn = 'Cobranza' ORDER BY opening_date DESC");
