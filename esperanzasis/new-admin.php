    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container">
                    <h2 class="mb-4 d-flex justify-content-start">Registrar nuevo admin</h2>
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <form action="new-admin.php" method="POST">
                                                ...
                                                <div class="col-md-6 col-sm-12 col-lg-6 col-xl-6 col-xxl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="tipo" require class="form-select">
                                                            ...
                                                            <option value="AdminConjuntla">AdminConjuntla</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-grid gap-2">
                                                <input type="submit" value="Crear nuevo rol" class="btn btn-outline-success" name="saveAdmin">
                                            </div>
                                    </form>
                                </div>
                            </div>
