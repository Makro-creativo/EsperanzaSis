<?php 
    ...
    if(isset($_POST['editBills'])) {
        ...
        $query_update_bills = "UPDATE bills SET customer_name='$name_customer', amount='$amount', iva='$iva', concept='$concept', date_saved='$date_saved' WHERE id_customer = '$id_customer'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <?php 
                    ...
                    $query_search_customer = "SELECT * FROM bills WHERE id_customer = '$id_customer'";
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-lg-6 col-xl-6 col-xxl-6">
                                                <div class="form-group">
                                                    <label>Elijir cliente: </label>
                                                    <select name="name_customer" require class="form-select">
                                                        <option selected disabled>Seleccionar cliente</option>
                                                        <?php 
                                                            include "./config/conexion.php";

                                                            $query_customer_update = "SELECT * FROM customers";
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-12">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $date_saved; ?>" type="date" name="date_saved" class="form-control" min="<?php echo date('Y-m-d'); ?>">
                                                </div>
                                            </div>
                                        </div>
