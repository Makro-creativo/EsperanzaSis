                                                ...
                                                <tbody>
                                                        ...
                                                        <?php 
                                                            ...
                                                            if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                                            {
                                                                ...
                                                                $query = "SELECT * FROM gastos WHERE created_at BETWEEN '$from_date' AND '$to_date' ORDER BY created_at DESC";
                                                                ...
                                                                if(mysqli_num_rows($query_run) > 0)
                                                                {
                                                                    foreach($query_run as $row)
                                                                    {
                                                                        ...
                                                                        <?php
                                                                        $total_neto = $total_row+=$row['amount'];
                                                                    }
                                                                }
                                                                else
                                                                {
                                    ...
                                    <div class="row mt-2">
                                        <p class="text-primary text-center">Exportar a excel entre fechas</p>
                                            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 cool-xxl-12">
                                                <form method="POST" class="form" action="report-gastos-export.php">
                                                    <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
