                                        ...
                                        <table class="table table-bordered" id="dataTable">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    $search_orders_to_credito = "SELECT * FROM ordens_admin INNER JOIN status_payment ON ordens_admin.purchaseid = status_payment.order_id WHERE payment_status = 'Pagado'";
