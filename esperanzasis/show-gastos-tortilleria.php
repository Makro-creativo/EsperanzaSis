                                                    ...
                                                    <table class="table table-borderd" id="data" width="100%" cellspacing="0">
                                                        ...
                                                        <?php 
                                                            ...
                                                            if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                                            {
                                                                ...
                                                                $query = "SELECT * FROM cutbox_ruta WHERE opening_date BETWEEN '$from_date' AND '$to_date' ORDER BY opening_date DESC";
                                        ...
                                        <table class="table table-bordered" id="render-table" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    $searchData = "SELECT * FROM cutbox_ruta ORDER BY opening_date ASC";
                                                    $result = mysqli_query($conexion, $searchData);
