<?php
    ...
    $reports_cutbox_super_morning = "SELECT * FROM cutbox_super WHERE turn = 'mañana' ORDER BY opening_date ASC";
    $result_cutbox_super_morning = mysqli_query($conexion, $reports_cutbox_super_morning);
?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 cool-xxl-12">
                                            <form method="POST" class="form" action="report-cutbox-super-morning.php">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                ...
                                                <div class="d-grid gap-2">
                                                    <input type="submit" name="generar_reporte" value="Descargar" class="btn btn-success">
                                                </div>
                                            </form>
                                            <br>
                                        </div>
