    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-12">
                            ...
                            <p class="text-primary text-center p-3">Exportar a excel entre fechas</p>
                                <div class="card-body">
                                    <form method="POST" class="form" action="report-order-cobrado.php">
                                        <div class="row">
                                            <div class="col-md-6">
                ...
                <div class="container">
                    <div class="row">
                        <h2 class="d-flex justify-content-start mb-4">Pedidos cobrados</h2>
                                        ...
                                        <table class="table table-bordered" id="dataTable">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    $search_orders_to_credito = "SELECT * FROM ordens_admin WHERE status_payment = 'cobrado' ORDER BY purchaseid ASC";
