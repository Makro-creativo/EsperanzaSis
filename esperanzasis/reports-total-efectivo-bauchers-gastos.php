    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container">
                    <div class="row">
                        <h2 class="d-flex justify-content-start mb-4">Total de venta turno de la mañana</h2>
                                                        ...
                                                        <table class="table table-bordered" id="data" width="100%" cellspacing="0">
                                                            ...
                                                            <?php 
                                                                ...
                                                                if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                                                {
                                                                    ...
                                                                    $query = "SELECT * FROM cutbox_super WHERE opening_date BETWEEN '$from_date' AND '$to_date' AND turn = 'mañana' ORDER BY opening_date DESC";
