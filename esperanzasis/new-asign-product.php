<?php 
    ...
    if(isset($_POST['save'])) {
        $idProduct = $_POST['id_name_product'];
        $idClient = $_POST['id_name_client'];

        $query = "INSERT INTO assign_product(product_id, client_id, status_deleted, created_at) VALUES('$idProduct', '$idClient', '0', NOW())";
        $result = mysqli_query($conexion, $query);

        if($result) {
            echo "<script>window.location='new-asign-product.php?success'; </script>";
        }
    }
    ...
    <div id="wrapper">
        ...
        ?>
            <script>
                Swal.fire({
                    title: 'Listo',
                    text: 'Se asigno correctamente el producto!',
                    icon: 'success',
                ...
                <div class="container">
                    <div class="row">
                        <div class="d-flex justify-content-around align-items-center">
                            <h2 class="mb-4">Asigar Producto a Cliente</h2>
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-12 mx-auto">
                            <div class="card shadow-lg">
                                <div class="card-header">Asignar nuevo producto a cliente</div>

                                <div class="card-body">
                                    <form action="new-asign-product.php" method="POST">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-lg-6 col-xl-6 col-xxl-6">
                                                <div class="form-group">
                                                    <label>Producto: </label>
                                                    <select name="id_name_product" class="form-control js-example-basic-single" required>
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $idproduct; ?>"><?php echo $nameProduct; ?> - <?php echo number_format($productPrice, 2)." Pesos"; ?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-xm-12 col-lg-6 col-xl-6 col-xxl-6">
                                                <div class="form-group">
                                                    <label>Cliente: </label>
                                                    <select name="id_name_client" class="form-control js-example-basic-single" required>
                                        ...
                                        <div class="d-grid gap-2">
                                            <input type="submit" class="btn btn-outline-success mt-4" value="Guardar" name="save">
                                        </div>
                                    </form>
                                </div>
                            </div>
