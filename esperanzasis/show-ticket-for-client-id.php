        ...
        <div class="ticket">
            ...
            <?php 
                ...
                if(isset($_GET['id'])) {
                    ...
                    $query_client = "SELECT date_send, number_note, status_payment, id FROM new_orders_admin WHERE id = '$idOrder'";
                    $result_client = mysqli_query($conexion, $query_client);

                    if($result_client) {
                        $rowTwo = mysqli_fetch_array($result_client);
            ...
            <table>
                ...
                <?php 
                    ...
                    $query_ticket = "SELECT * FROM new_orders_admin 
                        INNER JOIN purchase_detail_admin ON new_orders_admin.id = purchase_detail_admin.purchaseid 
                        INNER JOIN clients ON clients.id = new_orders_admin.client_id 
                        INNER JOIN products ON products.id = purchase_detail_admin.productid 
                        WHERE new_orders_admin.id = '$id_order'";
