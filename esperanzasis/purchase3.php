											...
											<?php
												...
												?>
													<tr>
														...
														<td>
															<!--<input placeholder="Cantidad del producto: 0" type="text" class="form-control" autocomplete="off" name="quantity_<?php //echo $iterate; ?>">-->
															<input placeholder="Cantidad del producto: 0" type="text" class="form-control" autocomplete="off" name="quantity[]">
														</td>
