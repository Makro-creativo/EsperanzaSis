    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container">
                    <h2 class="d-flex justify-content-start mb-4">Facturas Pagadas</h2>
                    <div class="row">
                                        ...
                                        <table class="table table-bordered" id="table-rendering" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    $query_payments = "SELECT * FROM bills_to_pay INNER JOIN payment_status_to_pay ON bills_to_pay.id_provider = payment_status_to_pay.id_provider AND payment_status_to_pay.payment = 'Pagada'";
