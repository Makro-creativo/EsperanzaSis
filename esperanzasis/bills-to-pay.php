...
<body id="page-top">
                               ...
                               <div class="card animate__animated animate__fadeIn shadow-lg">
                                   <div class="card-header d-flex justify-content-around">
                                       <?php 
                                           ...
                                           $query_bills_id = "SELECT date_bills_to_pay FROM bills_to_pay WHERE id_provider = '$id_provider'";
                                           $result_bills_id = mysqli_query($conexion, $query_bills_id);

                                           while($row = mysqli_fetch_array($result_bills_id)) {
                                       ?>
                                       ...
                                       Estatus: <?php 
                                               ...
                                               $search_status_to_pay = "SELECT payment, CASE WHEN payment = 'Pagada' THEN 'Pagada' WHEN payment = 'Por cobrar' THEN 'Por cobrar' ELSE 'No hay estatus' END FROM payment_status_to_pay WHERE id_provider = '$id_provider'";
                                               $result_status_to_pay = mysqli_query($conexion, $search_status_to_pay);

                                               while($row = mysqli_fetch_array($result_status_to_pay)) {
                                      ...
                                      <a href="edit-bills-status-id.php?id_provider=<?php echo $id_provider; ?>" class="btn btn-info btn-sm">
                                          Editar estatus
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-4 col-sm-12 col-lg-4 col-xl-4 col-xxl-4">
                            <div class="card shadow-lg card-hide"  style="display: block;">
                                ...
                                <div class="card-body">
                                    <form action="save-status-bills-to-pay.php" method="POST">
                                        <input type="hidden" name="id_save_payment" value="<?php echo $id_provider; ?>">
    ...
    $("#generate-pdf").click(function(){
        ...
        <?php foreach($data as $bills):?>
            [<?php echo $bills->id_provider; ?>, 
            "<?php echo $bills->name_customer; ?>", 
